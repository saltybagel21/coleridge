...
export const ShopGrid: React.FC = () => {
  const { orderType, openCart, count, setOrderType } = useCart();
  ...
  const baseProducts = activeOrderType === "retail" ? RETAIL_PRODUCTS : WHOLESALE_PRODUCTS;
  const products = useLiveProducts(baseProducts, activeOrderType);
